...
namespace Next_Game.Cartographic
{
    ...
    public enum MapLayer { Base, Movement, NPC, LocID, Debug, HouseID, Capitals, RefID, Geography, Terrain, GeoID, Road, Followers, Enemies, EnemiesDebug, Inquisitors, Threats, ThreatsDebug, Count } //Count must be last
                        ...
                        else
                        {
                            ...
                            switch (mainLayer)
                            {
                                ...
                                case 1:
                                    ...
                                    houseID = mapGrid[(int)MapLayer.HouseID, column, row];
                                    if (houseID > 0)
                                    {
                                        // house
                                        if (houseID < 99) 
                                ...
                                case 20:
                                    ...
                                    subCell[5] = 179;
                                    subCell[8] = 179;
                                    foreColor2 = RLColor.LightMagenta;
                                    foreColor5 = RLColor.LightMagenta;
                                    foreColor8 = RLColor.LightMagenta;
                                    break;
                                //road lateral route
                                case 21:
                                    subCell[4] = 196;
                                    subCell[5] = 196;
                                    subCell[6] = 196;
                                    foreColor4 = RLColor.LightMagenta;
                                    foreColor5 = RLColor.LightMagenta;
                                    foreColor6 = RLColor.LightMagenta;
                                    break;
