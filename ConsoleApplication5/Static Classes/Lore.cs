                        ...
                        switch (rndNum)
                        {
                            ...
                            case 7:
                                ...
                                if (rnd.Next(100) < 60)
                                {
                                    ...
                                    knight.AddPossession(secret.PossID);
                                }
                                break;
                            case 8:
                            case 9:
                        ...
                        switch (rndNum)
                        {
                            ...
                            case 5:
                                ...
                                if (rnd.Next(100) < 60)
                                {
                                    ...
                                    Game.history.SetSecret(secret);
                                    royal.AddPossession(secret.PossID);
                                }
                                break;
                            case 6:
                            case 7:
                        ...
                        switch (rndNum)
                        {
                            ...
                            case 5:
                                ...
                                if (rnd.Next(100) < 60)
                                {
                                    ...
                                    Game.history.SetSecret(secret);
                                    rebel.AddPossession(secret.PossID);
                                }
                                break;
                            case 6:
                                //Bad leadership
            ...
            foreach (int actorID in listOfCapturedActors)
            {
                ...
                switch (rndNum)
                {
                    ...
                    case 5:
                        ...
                        Game.history.SetSecret(secret);
                        actor.AddPossession(secret.PossID);
                        truth = false;
                        break;
                    case 6:  
                    case 7:
                        ...
                        if (rnd.Next(100) < 50)
                        {
                            ...
                            actor.AddPossession(secret_1.PossID);
                            truth = false;
                        }
                        break;
                    case 8:
            ...
            else if (advisor.advisorRoyal > AdvisorRoyal.None)
            {
                ...
                if (rnd.Next(range) < Game.constant.GetValue(Global.ADVISOR_REFUSAL))
                {
                    ...
                    if (rnd.Next(0, 6) < liegeTreachery )
                    {
                        ...
                        advisor.AddPossession(secret.PossID); liege.AddPossession(secret.PossID);
                    }
                }
                else
                {
                    ...
                    if (rnd.Next(100) < (advisorTreachery * 5))
                    {
                        ...
                        advisor.AddPossession(secret.PossID);
                    }
                }
