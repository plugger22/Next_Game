...
namespace Next_Game
{
    public class World
    {
        ...
        private string InitiateMoveCharacters(int charID, Position posOrigin, Position posDestination, List<Position> path)
        {
        ...
        private Position GetCharacterLocationByPos(int charID)
        {
