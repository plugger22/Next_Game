...
{
    public enum TriggerCheck { None, Trait, GameVar, RelPlyr, Sex, ActorType, ResourcePlyr, Known, Introduction, Desire, Promise, Disguise, TravelMode, HorseStatus, Season} 
