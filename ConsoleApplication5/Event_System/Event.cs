...
namespace Next_Game.Event_System
{
    ...
    public enum EventFilter { None, Court, Visitors, Followers, Advisors, Interact, Passage} //used by auto location player events to determine which group of actors to show as options
