...
namespace Next_Game.Event_System
{
    ...
    public enum EventFilter { None, Court, Visitors, Followers, Advisors, Interact, Docks, FindShip, BribeCaptain, Recruit, TheyWant, YouWant, SafeHouse, Dungeon, SpeakPrisoner, SpeakCouncil} //used by autoloc plyr events to determine which group of actors to show as options
