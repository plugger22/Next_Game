...
namespace Next_Game.Event_System
{
    ...
    public enum EventCalc { None, Add, Subtract, Random, Equals, NotEqual, GreaterThanOrEqual, LessThanOrEqual, Count} //used within events for triggers (>, <, =, !=) and outcomes (+, -, Random)
